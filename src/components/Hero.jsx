...
const Hero = () => {
  return (
    <div className='pb-4 lg:mb-360'>
        <div className='flex flex-wrap lg:flex-row-reverse'>
            <div className='w-full lg:w-1/2'>
            <div className='flex justify-center lg:p-8'>
                <motion.img src={profilePic} alt="Maheswari" className='border border-stone-900 rounded-3xl'
                width={600}
                height={500}
            ...
            className='flex flex-col items-center lg:items-start mt-10'>
                <motion.h2
                 ...
                 className='pb-2 text-4xl tracking-tighter lg:text-8xl'>Maheswari</motion.h2>
                <motion.span
                   variants={childVariants}
                ...
                <motion.a 
                variants={childVariants}
                href="/MAHESWARI.pdf" target='_blank' rel='noopener noreferrer'
                download
